#code from siraj's live session
from numpy import *

def compute_error_for_given_points(b, m, points): #square error formula
    totalError = 0
...
def run():
    ...
    #hyperparameters
    learning_rate = 0.0001 #How fast it will learn - we set a balance/optimum.
    ...
    print "After {0} iterations b = {1}, m = {2}, error = {3}".format(num_interations, b, m, compute_error_for_given_points(b, m, points))
